...
public class TableCTAddition extends Propagator<BitsetIntVarImpl> {
    TableCTAddition.RSparseBitSet currTable;
    ...
    public TableCTAddition(BitsetIntVarImpl[] vars, Tuples tuples) {
        super(vars, PropagatorPriority.QUADRATIC, true);
        this.tuples = tuples;
        this.currTable = new TableCTAddition.RSparseBitSet(this.model.getEnvironment(), this.tuples.nbTuples());
